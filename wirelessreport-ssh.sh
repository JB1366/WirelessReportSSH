...
ScriptUpdateFromAMTM() {
    ...
    if do_update; then
        ...
        echo -e "\n  [✓] Wireless Report SSH successfully updated.\n"
...
check_github() {
	GITHUB="https://raw.githubusercontent.com/JB1366/WirelessReportSSH/main/wirelessreport-ssh.sh"
...
<head>
<meta charset="UTF-8" />
<title>W Report SSH $SCRIPT_VERSION$VERSION_HASH</title>
